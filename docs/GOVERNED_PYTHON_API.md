...
This guide describes `tn-proto==2026.9.14b1` on Python 3.10 or newer. The distribution includes native Rust-backed governed objects, independent sessions, provider interfaces, and Python business-data views. Linux x86-64 and Windows x64 wheels are the supported release targets.
