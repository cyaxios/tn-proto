...
//
// The byte-interop test loads the shared Python-produced golden vector
// (../../tests/fixtures/recipient_wraps/vector.json, generated by
// python/tools/generate_recipient_wrap_fixture.py) and unseals it in TS.
// The Python side asserts the same vector in
// python/tests/test_recipient_wrap_contract.py. A passing
...
// Shared cross-language golden vector (repo-root tests/fixtures/), the
// single source of truth also consumed by the Python contract test
// (python/tests/test_recipient_wrap_contract.py). Generated by
// python/tools/generate_recipient_wrap_fixture.py.
const FIXTURE_PATH = resolve(HERE, "..", "..", "tests", "fixtures", "recipient_wraps", "vector.json");
