 ...
 *
 * Carries `device_identity` post 0.4.3a1 naming flip. The wire-format
 * envelope key was renamed from `did` to `device_identity`; the flat-dict
 * surface (this layer) and Entry's typed attribute followed suit.
 */
