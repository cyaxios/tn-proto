...
//
// Usage:
//   node test/btn_interop.mjs             # step 1: JS produces, writes btn_fixture.json
//   python test/btn_py_check.py           # step 2: Python decrypts + cross-check
//   node test/btn_interop.mjs --verify-py # step 3: JS decrypts Python's output
//
