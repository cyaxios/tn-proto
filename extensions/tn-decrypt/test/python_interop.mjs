...
//
// Notes:
//   - This test exercises only the decrypt path, no unlock state (the
//     passphrase-fallback path is orthogonal).
//   - dashboard wasm_e2e covers the reverse direction (JS -> Python).
//   - Output uses the rich `[ext:test]` structured form.
