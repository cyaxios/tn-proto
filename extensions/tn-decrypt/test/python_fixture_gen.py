...
Notes:
  - Fixture construction is deterministic: the same plaintext always
    produces a decryptable ciphertext.
  - The fixture path is independent of unlock state (passphrase
