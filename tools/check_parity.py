...
_VERB_ALLOW: dict[str, Allow] = {
    ...
    # ----------------------------------------------------------------------
    "wallet": Allow(
        "TS gap, future work (no TS port yet): Python's tn.wallet (link / "
        "backup / recovery story) has no TypeScript counterpart. Tracked as a "
        "Python-only surface until the wallet flow is ported.",
        side="py",
        gap=True,
    ),
    "vault_client": Allow(
