...
def run_demo(tmp_dir: Path) -> dict[str, Any]:
    ...
    # --- Step 1: mint N_RECIPIENTS reader kits ---
    ...
    # --- Step 3: revoke recipients 0..N_TO_REVOKE-1 ---
    ...
    # --- Step 4: emit POST_REVOKE_EVENTS ---
    ...
    # --- Step 5: verify which kits can decrypt what ---
