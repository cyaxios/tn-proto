...
Contract: ``docs/cli-test-plans/absorb.md``. This is the Python side of
the same-language round-trip the plan calls for — there was previously
**zero** coverage of ``cmd_absorb`` (the CLI verb). ``test_absorb.py``
