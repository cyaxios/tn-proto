...
This closes the security hole the read_watch audit (docs/cli-test-plans/
read_watch.md §5.2, §5.3, §7.2) flagged: *every* existing tamper test mutates
...
verify clean), which had zero direct coverage (audit §7.1).
