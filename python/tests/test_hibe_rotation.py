...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="hiberotate_") as td:
        ws = Path(td)
        ...
        print("rotation: old grantee keeps epoch.a, loses epoch.b")
        tn.flush_and_close()
        ...
        print("rotation: authority reads across epochs")
        tn.flush_and_close()
