"""Tests for the vault.push handler's INIT-UPLOAD mode.

Covers:

* Body-encryption parameter on ``tn.pkg.export``: round-trip
...
# ---------------------------------------------------------------------------
# tn.pkg.export(encrypt_body_with=...) body-encryption
# ---------------------------------------------------------------------------
