...
SDK-pure pytest e2e. No browser.
...
class _AsgiPushClient:
    ...
    def post_pending_claim(
        ...
        to this package's inbox at bind time.
        """
        async def _go():
            headers = {
                "Content-Type": "application/octet-stream",
...
# The SDK push/pull orchestration is covered above. An optional
