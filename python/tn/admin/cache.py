...
class SameCoordinateFork:
    ...
    different ``row_hash``. This is the equivocation primitive:
    typically caused by two devices holding the same private key
    and writing independently while offline.
    """
...
class AdminStateCache:
    ...
    See the module docstring for the convergence rules and full design.
    """
    ...
    def diverged(self) -> bool:
        ...
        are tracked separately. Forks are coordinate-level disagreements
        between independently-signed envelopes from the *same* writer.
        """
        self._refresh_if_log_advanced()
    ...
    # plus the revocation-is-terminal extension)
    # ------------------------------------------------------------------
