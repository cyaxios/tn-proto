"""Passphrase-fallback restore path.
...
project BEK directly in the CLI. This rides the same key hierarchy as
the browser path: a per-account AWK wraps a per-project BEK. Only
PBKDF2-SHA256 is supported here; Argon2id KDFs require the browser path
because we don't ship an argon2 dependency in the Python SDK.
"""
