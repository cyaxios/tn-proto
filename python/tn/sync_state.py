...
between init-upload and steady-state modes.
...
# --- Init-upload / claim-binding helpers ---
...
def is_account_bound(yaml_path: Path) -> bool:
    ...
    Once the user claims, a subsequent vault probe (or the bind-echo)
    flips this to True. The handler reads it on every
