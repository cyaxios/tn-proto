...
Python, TypeScript, and Rust use the same object format. This README walks through the Python API. For existing identity, key, or policy services, see the [management systems guide](https://github.com/cyaxios/tn-proto/blob/main/docs/MANAGEMENT_SYSTEMS.md). The [Unity Catalog guide](https://github.com/cyaxios/tn-proto/blob/main/docs/UNITY_CATALOG.md) shows how to locate and open a stored TN object.

[Install](https://github.com/cyaxios/tn-proto/blob/main/README.md#install) · [First object](https://github.com/cyaxios/tn-proto/blob/main/README.md#your-first-object) · [Bank and vendor](https://github.com/cyaxios/tn-proto/blob/main/README.md#from-a-greeting-to-a-bank-report) · [Application rules](https://github.com/cyaxios/tn-proto/blob/main/README.md#optional-application-rules) · [Python API](https://github.com/cyaxios/tn-proto/blob/main/README.md#python-api) · [Keys and providers](https://github.com/cyaxios/tn-proto/blob/main/README.md#keys-and-providers) · [Application examples](https://github.com/cyaxios/tn-proto/blob/main/python/examples/enterprise/README.md)
...
Python 3.10 or newer. Linux x86-64 and Windows x64 wheels include the Rust implementation. These examples are checked against `tn-proto==2026.9.14b1`. For other languages, see the [TypeScript SDK](https://github.com/cyaxios/tn-proto/blob/main/ts-sdk/README.md) and [Rust SDK](https://github.com/cyaxios/tn-proto/blob/main/rust-sdk/README.md).
...
The greeting used one application and one field. The [bank/vendor program](https://github.com/cyaxios/tn-proto/blob/main/python/examples/bank_vendor.py) uses two applications with separate identities and keys. Amounts and customer names go into separate groups. The use contract goes into an encrypted governance group that both applications can read:
